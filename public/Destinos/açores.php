...
if (isset($_SESSION['id']) && isset($_SESSION['user_name'])) {
    $destination_id = 25;
    $destination_name = "Açores";
    $description = "Voo c/ maço de tabaco e fino incluido";
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Viagens para <?php echo $destination_name; ?></title>
    ...
    <style>
        html {
            background: url('<?php echo "../../assets/images/Açores.jpeg"; ?>') no-repeat center center fixed;
...
<body>
    <nav>
        ...
        <div id="titulo">
            <h1>Book your trip to <?php echo $destination_name; ?></h1>
        </div>
